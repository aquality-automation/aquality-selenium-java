...
public class Browser implements IApplication {
    ...
    public Browser(RemoteWebDriver remoteWebDriver) {
        ...
        getDriver().manage().timeouts().implicitlyWait(Duration.ofSeconds(implicitTimeout.getSeconds()));
    ...
    public void setPageLoadTimeout(Duration timeout) {
        if (!getBrowserName().equals(BrowserName.SAFARI)) {
            ...
            getDriver().manage().timeouts().pageLoadTimeout(Duration.ofSeconds(timeout.getSeconds()));
        }
    }
    ...
    public void setImplicitWaitTimeout(Duration timeout) {
        if (!timeout.equals(getImplicitWaitTimeout())) {
            ...
            getDriver().manage().timeouts().implicitlyWait(Duration.ofSeconds(timeout.getSeconds()));
    ...
    public void setScriptTimeout(Duration timeout) {
        ...
        getDriver().manage().timeouts().scriptTimeout(Duration.ofSeconds(timeout.getSeconds()));
    }
